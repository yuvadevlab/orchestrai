...
import { TopologyConstellation } from "@/features/overview/topology-constellation";
import { CommandCenterHero } from "@/features/overview/command-center-hero";
import { OverviewGrids } from "@/features/overview/overview-grids";
import { executions } from "@/lib/mock-db";

/**
 * Overview / Command Center Route.
 * Mirroring the exact Lovable Command Center experience with animated topology and prompt orchestrator.
 */
