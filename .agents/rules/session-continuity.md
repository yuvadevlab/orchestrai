...
1. **Read Status**:
   - Inspect [`PROGRESS.md`](file:///Users/yuvarajpattabi/Yuva/yuva-devlab/Repos/orchestrai/PROGRESS.md) to identify the current Phase and Feature.
   - Inspect the latest entries in [`IMPLEMENTATION-LOG.md`](file:///Users/yuvarajpattabi/Yuva/yuva-devlab/Repos/orchestrai/IMPLEMENTATION-LOG.md).
...
2. **Update Progress Tracking**:
   - Update [`PROGRESS.md`](file:///Users/yuvarajpattabi/Yuva/yuva-devlab/Repos/orchestrai/PROGRESS.md) with updated phase/feature states (`[x]`, `[~]`, `[ ]`).
   - Update `ORCHESTRAI-IMPLEMENTATION.md` section status if a phase or major section was completed.
3. **Log Completed Work**:
   - Add an entry in [`IMPLEMENTATION-LOG.md`](file:///Users/yuvarajpattabi/Yuva/yuva-devlab/Repos/orchestrai/IMPLEMENTATION-LOG.md) containing:
     - Date & Phase
